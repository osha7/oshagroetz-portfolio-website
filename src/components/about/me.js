    ...
    return (
        <div> 
            <div className="me">
                    ...
                    Possessing an acute eye for graphic design & marketing with a passion for innovative tech. Experienced in React.JS and Ruby on Rails based programming with a background in business development and start-up growth.
